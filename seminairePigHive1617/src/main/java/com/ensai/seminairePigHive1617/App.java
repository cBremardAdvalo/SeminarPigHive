package com.ensai.seminairePigHive1617;
...
public class App 
{
	...
	public static final String KEY_KISS_PRICE = "kissPrice";
	...
	public static void main( String[] args )
    {
    	...
    	GlobalStat gs = GlobalStat.getInstance(
    			...
    			Double.parseDouble(globalMap.get(KEY_KISS_PRICE)),
